                        ...
                        <tr>
                            <td class="py-4 px-6 border-b border-grayScale-300">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-grayScale-700">Ahmad Akbar</p>
                            ...
                            <td class="py-4 px-6 border-b border-grayScale-300 text-center">
                                ...
                                <a href="{{ route('nilai.prinsip.detail') }}" class="mt-2 text-xs py-1 px-3 bg-grayScale-200 text-grayScale-700 hover:bg-white hover:ring-1 hover:ring-primary transition-all ease-in-out hover:font-medium rounded">Lihat
                                    Tugas</a>
                            </td>
                            <td class="py-4 px-6 border-b border-grayScale-300 text-center">
